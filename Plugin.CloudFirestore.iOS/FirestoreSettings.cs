...
namespace Plugin.CloudFirestore
{
    public partial class FirestoreSettings
    {
        ...
        internal Firebase.CloudFirestore.FirestoreSettings ToNative()
        {
            return new Firebase.CloudFirestore.FirestoreSettings
            {
                TimestampsInSnapshotsEnabled = AreTimestampsInSnapshotsEnabled,
                Host = Host,
