...
namespace Plugin.CloudFirestore
{
    public class DocumentSnapshotWrapper : IDocumentSnapshot, IEquatable<DocumentSnapshotWrapper>
    {
        ...
        public ISnapshotMetadata Metadata => throw new NotImplementedException();  //new SnapshotMetadataWrapper(_documentSnapshot.Metadata);
        ...
        {
            var value = _documentSnapshot.GetValue<T>(field).ToFieldValue(new DocumentFieldInfo<T>());
        ...
        {
            var value = _documentSnapshot.GetValue<T>(field?.ToNative()!).ToFieldValue(new DocumentFieldInfo<T>());
            return value is not null ? (T)value : default;
        }
