...
namespace Plugin.CloudFirestore
{
    public partial class FirestoreSettings
    {
        ...
        internal Firebase.Firestore.FirebaseFirestoreSettings ToNative()
        {
            return new Firebase.Firestore.FirebaseFirestoreSettings.Builder()
                .SetTimestampsInSnapshotsEnabled(AreTimestampsInSnapshotsEnabled)
                .SetHost(Host)
